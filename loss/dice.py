...
class SoftDiceLoss_Tversky(nn.Module):
    def __init__(self, apply_nonlin: Callable = None, batch_dice: bool = False, do_bg: bool = True, smooth: float = 1.,
                 ddp: bool = True, clip_tp: float = None, alpha=0.7, beta = 0.3):
        """
        """
        super(SoftDiceLoss_Tversky, self).__init__()
    ...
    def forward(self, x, y, loss_mask=None):
        ...
        nominator = 2 * tp
        denominator = 2 * tp + self.alpha*fp + self.beta * fn
